    ...
    for (int i = 0; i < candidate_count; i++)
    {
        for (int j = i + 1; j < candidate_count; j++)
        {
            if (preferences[i][j] > preferences[j][i])
            {
                ...
                votes[pair_count].vote_winner = preferences[i][j];
                votes[pair_count].vote_loser = preferences[j][i];
                pair_count++;
            }
            else if (preferences[i][j] < preferences[j][i])
            {
                ...
                votes[pair_count].vote_winner = preferences[j][i];
                votes[pair_count].vote_loser = preferences[i][j];
                pair_count++;
            }
        }
    }
